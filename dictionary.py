...
# -----------------------------------------------------------------------------
# TOPIC DICTIONARIES
# Substring match on lowercased text — same logic as dict_score.
# A paragraph can match multiple topics simultaneously.
# -----------------------------------------------------------------------------
TOPICS = {
    'judiciary_rule_of_law': [
        'judicial', 'judiciary', 'court', 'courts', 'judge', 'judges',
        'prosecution', 'prosecutor', 'rule of law', 'case backlog',
        'independence', 'legal certainty', 'enforcement of decisions',
    ],
    'corruption_anti_corruption': [
        'corruption', 'corrupt', 'fraud', 'bribery',
        'anti-corruption', 'integrity', 'transparency',
        'asset declaration', 'conflict of interest',
    ],
    'public_administration_governance': [
        'public administration', 'administration', 'civil service',
        'governance', 'institutional capacity', 'coordination',
        'implementation capacity', 'policy implementation',
    ],
    'political_functioning': [
        'political', 'parliament', 'assembly', 'government',
        'opposition', 'polarisation', 'cooperation',
        'dialogue', 'legislative', 'elections',
    ],
    'economy_market': [
        'economic', 'economy', 'market', 'growth', 'inflation',
        'employment', 'investment', 'business environment',
        'competitiveness',
    ],
}
